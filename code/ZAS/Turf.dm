...
/turf/return_air()
	...
	GM.adjust_multi("oxygen", oxygen, "carbon_dioxide", carbon_dioxide, "nitrogen", nitrogen, "toxins", toxins)
...
/turf/remove_air(amount as num)
	...
	if(sum>0)
		...
		GM.gas["toxins"] = (toxins/sum)*amount
...
/turf/proc/make_air()
	...
	air.adjust_multi("oxygen", oxygen, "carbon_dioxide", carbon_dioxide, "nitrogen", nitrogen, "toxins", toxins)
