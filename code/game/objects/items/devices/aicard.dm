/obj/item/device/aicard
	...
	attack(mob/living/silicon/ai/M as mob, mob/user as mob)
		...
		msg_admin_attack("[key_name_admin(user)] used the [src.name] to card [key_name_admin(M)] (<A HREF='?_src_=holder;adminplayerobservecoodjump=1;X=[user.x];Y=[user.y];Z=[user.z]'>JMP</a>)")
