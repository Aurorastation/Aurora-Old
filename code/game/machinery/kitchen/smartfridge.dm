...
/obj/machinery/smartfridge/medicine
	name = "\improper Pharmaceutical Storage"
	desc = "A storage unit for different pharmaceutical and chemical bottles."

/obj/machinery/smartfridge/medicine/accept_check(var/obj/item/O as obj)
	if(istype(O,/obj/item/weapon/reagent_containers/glass/bottle) || istype(O,/obj/item/weapon/storage/pill_bottle/))
		return 1
	return 0
