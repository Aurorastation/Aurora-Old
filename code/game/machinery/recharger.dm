...
obj/machinery/recharger
	...
	var/list/allowed_devices = list(/obj/item/weapon/gun/energy, /obj/item/weapon/melee/baton, /obj/item/weapon/cell)
...
obj/machinery/recharger/attackby(obj/item/weapon/G as obj, mob/user as mob)
	...
	if(allowed)
		...
		if(!isarea(a) || (a.power_equip == 0 && !a.unlimited_power))
			...
			return
		if (istype(G, /obj/item/weapon/gun/energy/rifle/gun/nuclear) || istype(G, /obj/item/weapon/gun/energy/crossbow))
