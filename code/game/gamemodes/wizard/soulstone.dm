...
//////////////////////////////Capturing////////////////////////////////////////////////////////
	...
	attack(mob/living/carbon/human/M as mob, mob/user as mob)
		...
		msg_admin_attack("[key_name_admin(user)] used the [src.name] to capture the soul of [key_name_admin(M)] (<A HREF='?_src_=holder;adminplayerobservecoodjump=1;X=[user.x];Y=[user.y];Z=[user.z]'>JMP</a>)")
