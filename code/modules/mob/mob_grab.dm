...
/obj/item/weapon/grab/proc/s_click(obj/screen/S)
	...
	if(state < GRAB_AGGRESSIVE)
		...
		if(state < GRAB_NECK)
			...
			msg_admin_attack("[key_name_admin(assailant)] grabbed the neck of [key_name_admin(affecting)] - <A HREF='?_src_=holder;adminplayerobservecoodjump=1;X=[affecting.x];Y=[affecting.y];Z=[affecting.z]'>JMP</a>")
